    ...
    <>
      ...
      <div className='min-h-full p-12 flex items-center justify-center'>
        <ul className='flex flex-col gap-y-6'>
          ...
          <li>
            <StoryBox time='2019'>
              <p>No ano de 2019, surge uma oportunidade para eu aprender esse instrumento que tanto almejava. Eu estava muito animado para aprender, porém, quando começo as aulas, me entregam um violão, fiquei chateado e com um até co raiva, não vou mentir.</p>
